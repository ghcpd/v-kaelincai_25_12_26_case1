...
This module is a copy of the original implementation with a fix for
the Left-Right (LR) double-rotation ordering bug.
"""
...
class AVLTree:
    ...
    def _insert_recursive(self, node, key, user_data):
        ...
        if balance > 1 and key > node.left.key:
            ...
            # Important: performing rotations in the reverse order corrupts
            # the tree structure (nodes can become unreachable).
